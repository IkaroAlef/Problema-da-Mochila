...
class Knapsack {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(knapsack(valores, pesos, pesoMax)); //imprime valor total que compõe a mochila
    }
    ...
    public static int knapsack(int valores[], int pesos[], int pesoMax) {
        ...
        //Se não há itens na casa(supoe q um ladrão vai roubar uma casa, porém não há itens para serem roubados)  
...
//Dado um pesos, checa se o valor do item atual somado com o valor do item que poderíamos dispor com o pesos restante é maior que o valor sem o item atual  
